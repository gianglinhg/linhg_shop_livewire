    ...
    <div class="container relative">
      <div class="row">
        ...
        <div class="ecommerce col">
          ...
          {{-- <form wire:submit.prevent='storeOrder' method="POST" name="checkout"
            class="checkout ecommerce-checkout row"> --}}
            <form
              action="@if($payment_method=='vnpay' ) {{route('vnpay')}} @elseif($payment_method=='paypal' ) 'paypal' @endif"
              method="POST" name="checkout" class="checkout ecommerce-checkout row">
              @csrf
              <div class="col-lg-7" id="customer_details">
                <div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <p class="form-row form-row-first validate-required ecommerce-invalid ecommerce-invalid-required-field form-group"
                        ...
                        <input type="text" class="form-control" value name="first_name" id="billing_first_name"
                    ...
                    <div class="col-md-6">
                      <p class="form-row form-row-last validate-required ecommerce-invalid ecommerce-invalid-required-field form-group"
                        ...
                        <input type="text" class="input-text form-control" value name="last_name" id="billing_last_name"
                  ...
                  <p class="form-row form-row-wide address-field validate-required ecommerce-invalid ecommerce-invalid-required-field form-group"
                    ...
                    <input type="text" class="input-text form-control" placeholder="Ví dụ: số 1, đường 2, kp 3" value
                      name="address" id="billing_address_1" wire:model='address'>
                    @error('address')
                    <small style="color:red">{{$message}}</small>
                    @enderror
                  </p>
                  ...
                  <p class="form-row form-row-wide address-field validate-required form-group" id="billing_city_field"
                    ...
                    <input type="text" class="input-text form-control" value name="town" id="billing_town"
                      wire:model='town'>
                    @error('town')
                    <small style="color:red">{{$message}}</small>
                    @enderror
                  ...
                  <p class="form-row form-row-first address-field validate-state form-group" id="billing_state_field"
                    ...
                    <input type="text" class="input-text form-control" placeholder value name="city" id="billing_city"
                      wire:model='city'>
                    @error('city')
                    <small style="color:red">{{$message}}</small>
                    @enderror
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <p class="form-row form-row-last validate-required validate-phone form-group"
                        ...
                        <input type="text" class="input-text form-control" value name="phone" id="billing_phone"
                          wire:model='phone'>
                        @error('phone')
                        <small style="color:red">{{$message}}</small>
                        @enderror
                    ...
                    <div class="col-md-6">
                      <p class="form-row form-row-first validate-required validate-email form-group"
                        ...
                        <input type="text" class="input-text form-control" value name="email" id="billing_email"
                          wire:model='email'>
                        @error('email')
                        <small style="color:red">{{$message}}</small>
                        @enderror
                ...
                <div>
                  <p class="form-row notes ecommerce-validated form-group" id="order_comments_field">
                    ...
                    <textarea name="order_note" class="input-text form-control" id="order_note"
                ...
                <div class="order-review-wrap ecommerce-checkout-review-order" id="order_review">
                  ...
                  <div id="payment" class="ecommerce-checkout-payment">
                    ...
                    <ul class="payment_methods methods" x-data="{selected: 0}">
                      <li class="cod">
                        <div>
                          <input id="cod" type="radio" class="input-radio" name="payment_method" value="cod"
                      ...
                      {{-- <li class="payment_method_paypal">
                        <div class="d-flex">
                          <input id="payment_method_paypal" type="radio" class="input-radio" name="paypal"
                            value="paypal">
