  ...
  <div class="row">
    <div class="col-lg-3 col-md-6">
      <div class="card-box widget-box-two widget-two-primary">
        ...
        <div class="wigdet-two-content">
          ...
          <h2><span data-plugin="counterup">34578</span> <small><i class="mdi mdi-arrow-up text-success"></i></small>
          </h2>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="card-box widget-box-two widget-two-warning">
        ...
        <div class="wigdet-two-content">
          ...
          <h2><span data-plugin="counterup">52410</span> <small><i class="mdi mdi-arrow-up text-success"></i></small>
          </h2>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="card-box widget-box-two widget-two-danger">
        ...
        <div class="wigdet-two-content">
          ...
          <h2><span data-plugin="counterup">6352</span> <small><i class="mdi mdi-arrow-up text-success"></i></small>
          </h2>
          <p class="text-muted m-0"><b>Last:</b> 30.4k</p>
        </div>
      </div>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="card-box widget-box-two widget-two-success">
        ...
        <div class="wigdet-two-content">
          <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User Today">Tổng người truy cập</p>
          <h2><span data-plugin="counterup">895</span> <small><i class="mdi mdi-arrow-down text-danger"></i></small>
          </h2>
